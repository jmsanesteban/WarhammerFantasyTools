...
- **Untersuchung**: si el contacto pertenece a esta organización secreta, ese dato (y su(s) **grado(s)** — Escudo/Estilete/Gato/Brújula/Pluma/Corona/Carro/Paloma para agentes "con marca", Bazas/Contactos para colaboradores externos "sin marca"; un contacto puede tener varios a la vez) **solo se muestra si el personaje activo también es miembro** (marcado en su ficha) — un personaje no-miembro no lo ve, aunque el admin sí lo ve siempre. Es un eje de visibilidad independiente del permiso Total/Parcial.
