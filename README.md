...
- **Nivel y tipo de relación**: el nivel es un desplegable de 5 a -5 con etiqueta descriptiva (Amigo incondicional…Enemigo mortal). El tipo de relación es una selección múltiple (Baza, Unter/Untersuchung, Súbdito, Señor, Otra) — sustituye al antiguo grado "sin marca" de la Untersuchung.
