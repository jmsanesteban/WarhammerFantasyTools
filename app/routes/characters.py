...
def generator_roll():
    ...
    handlers = {
        ...
        'sucesos_juventud': lambda: {'eventos': ccs.roll_sucesos_juventud(int(ctx.get('num_rolls') or 1))},
        'talento_aleatorio': lambda: ccs.roll_talento_aleatorio(ctx.get('raza', 'Humano')),
